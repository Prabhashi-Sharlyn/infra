...
echo "Messaging Service Pipeline CI/CD..."
    ...
    "Statement": [
      {
        ...
        "Resource": "arn:aws:codebuild:ap-south-1:147997140755:project/betterwellness-messaging-service-build"
      }
    ]
  }'

aws cloudformation deploy \
  --template-file codepipeline-messaging-service.yaml \
  --stack-name messaging-service-pipeline-stack \
  --parameter-overrides \
    GitHubRepoUrl=https://github.com/Prabhashi-Sharlyn/messaging-service \
