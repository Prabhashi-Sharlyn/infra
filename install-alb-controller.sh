...
echo "Associate IAM OIDC provider for the EKS cluster..."
...
echo "Creating IAM service account for LoadBalancer controller..."
...
echo "Adding Helm repository for EKS charts and install the AWS Load Balancer Controller..."
...
echo "Applying CRDs for AWS Load Balancer Controller..."
kubectl apply -f https://raw.githubusercontent.com/aws/eks-charts/master/stable/aws-load-balancer-controller/crds/crds.yaml

echo "AWS Load Balancer Controller Deployment Done..."