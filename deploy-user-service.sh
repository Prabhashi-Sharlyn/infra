...
echo "User Service Pipeline CI/CD..."
    ...
    "Statement": [
      {
        ...
        "Resource": "arn:aws:codebuild:ap-south-1:147997140755:project/betterwellness-user-service-build"
      }
    ]
  }'

aws cloudformation deploy \
  --template-file codepipeline-user-service.yaml \
  --stack-name user-service-pipeline-stack \
  --parameter-overrides \
    GitHubRepoUrl=https://github.com/Prabhashi-Sharlyn/user-service \
